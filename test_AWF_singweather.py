...
def hyper_args():
    ...
    #
    parser.add_argument('--ir_path', default='/public/home/w__y/datasets/000/ir', type=str)
    parser.add_argument('--vi_path', default='/public/home/w__y/datasets/000/vi', type=str)
    parser.add_argument('--save_path', default='/public/home/w__y/datasets/000/result', type=str)
