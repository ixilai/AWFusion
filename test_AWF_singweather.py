...
def hyper_args():
    ...
    #
    parser.add_argument('--ir_path', default='../datasets/000/ir', type=str)
    parser.add_argument('--vi_path', default='../datasets/000/vi', type=str)
    parser.add_argument('--save_path', default='../datasets/000/result', type=str)
